...
2. Download [`PyPropControlPanelInstallation.zip`](https://github.com/xcape-io/PyPropControl/raw/master/PyControlPanel/PyControlPanelInstallation.zip) from this GitHub repository 
